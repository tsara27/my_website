...
function Hero() {
  return (
    <section className="hero flex justify-between p-32">
      <div className="w-2/5">
        <h1 className="font-display text-gray text-7xl mb-8 tracking-tighter">Tsara Fatma</h1>
      ...
      <div className="">
        <Image src="/images/hero-1.png" width={303} height={400}/>
      </div>
    </section>
  )
}
